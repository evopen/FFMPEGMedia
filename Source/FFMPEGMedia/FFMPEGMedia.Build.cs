...
public class FFMPEGMedia : ModuleRules
{
	...
	public bool LoadFFmpeg(ReadOnlyTargetRules Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			string LibrariesPath = Path.Combine(Path.Combine(Path.Combine(ThirdPartyPath, "ffmpeg", "lib"), "vs"),
				PlatformString);
			...
			string BinariesPath = Path.Combine(Path.Combine(Path.Combine(ThirdPartyPath, "ffmpeg", "bin"), "vs"),
				PlatformString);
		...
		else if (Target.Platform == UnrealTargetPlatform.Linux)
		{
			...
			string LibrariesPath = Path.Combine(Path.Combine(Path.Combine(ThirdPartyPath, "ffmpeg", "lib"), "linux"));
